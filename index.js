...
createMenuItem("Chicken", 2, "lunch");
createMenuItem("soup", 5, "lunch");
...
reviews.push({name:"Alex", rating: 4, feedback: "This place is wonderful!"});
console.log(reviews);
...
// console.log(carMaker(10).drive(100).odometer);
